  ...
  data () {
    return {
      ...
      formularOptions: { // Autocomplétion avec requete ou récupérer tout avant (une fois)
        ...
        occurences: [{ text: 'Choisir une occurence', value: null }, { text: 'spontané', value: 1 }, { text: 'journalier', value: 1 }, { text: 'hebdomadaire', value: 7 }, { text: 'bihebdomadaire', value: 14 }, { text: 'mensuel', value: 30 }],
